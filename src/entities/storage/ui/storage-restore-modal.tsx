  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md rounded-2xl border border-border bg-card p-5 shadow-2xl">
        <h3 className="text-lg font-semibold text-foreground">Восстановить</h3>
        <p className="mt-1 text-sm text-muted">
          Элемент: <span className="text-foreground">{itemName}</span>
        </p>
        ...
        <select
          ...
          className="mt-2 w-full rounded-xl border border-border bg-input px-3 py-2.5 text-sm text-foreground outline-none focus:border-blue-500"
        >
